...
<div class="firstDiv" style="max-width:100%">
	...
	<h1  class="intoText" align="center" id="demo"></h1><br>
...
<div class="form-popup" id="myForm">
  <form action="" class="form-container">
    ...
    <b><input type="submit" onclick="plsSign()" class="add_note" value="Add Note"></b>
    
    <b><input type="submit" onclick="plsSign()" class="add_event" value="Add Event"></b>

	<b><input type="submit" onclick="plsSign()" class="add_remainder" value="Remaider"></b>

 	<b><input type="submit" onclick="plsSign()" class="add_daily_task" value="Daily Task"></b>
